...
|Week|Objective|Courses|Deliverables|Status|
|----|---------|-------|------------|------|
|5|Protein Feature Engineering & ESM-2 Basics| • [ESM GitHub (Meta AI)](https://github.com/facebookresearch/esm)<br>• ESM-2 paper: [Evolutionary-scale prediction of atomic level protein structure with LLM](https://www.biorxiv.org/content/10.1101/2022.07.20.500902v3.full) | Notebook: [Protein Representation 101](./W5/w5_1_esm2_intro.ipynb)<br>• Compare One-Hot encoding vs. extracting "Pre-trained Embeddings" using the ESM-2 model (esm2_t6_8M_UR50D).<br>Notebook: [Visualizing the Protein Latent Space](./W5/w5_2_visualize_protein_latent_space.ipynb)<br>• Extract embeddings for ~1000 sequences and use t-SNE/UMAP to visualize functional clustering (e.g., Enzymes vs. Membrane proteins). | Done |
|6| Transformer Basics & Attention | • [3Blue1Brown: Attention in Transformers, Step-by-Step](https://www.youtube.com/watch?v=eMlx5fFNoYc)<br>• [The Illustrated Transformer (Jay Alammar)](https://jalammar.github.io/illustrated-transformer/)<br>• HuggingFace Course: Attention Mechanism |Notebook: [Identifying Functional Motifs via Self-Attention](./W6/w6_1_attention.ipynb)<br>• Visualize attention heatmap of a protein sequence<br>• Validate functional motif from attention scores| Done |
|7| Build a Transformer from Scratch |• [The Annotated Transformer (Harvard NLP)](https://nlp.seas.harvard.edu/2018/04/03/attention.html)<br>• [FFN with Martin](https://www.youtube.com/watch?v=aizh6ipm03k)<br>• [Transformer NN with StatQuest](https://www.youtube.com/watch?v=zxQyTK8quyY)  |Notebook: [Build a Micro-Transformer for DNA sequence](./W7/w7_1_micro_transformer_dna.ipynb)<br>• Positional Encodings<br>• Build a "Micro-Transformer" (2 layers) from scratch<br>• Train transformer on a small DNA classification task (e.g., TATA-box detection)| Done |
|8| Scaling & Production with Pytorch Lightning ||PyTorch Concept: PyTorch Lightning & Distributed Training.Refactor your GenomicTrainer into a LightningModule.Learn about Logging (using Weights & Biases or TensorBoard) and Checkpointing (saving only the "best" model automatically).Experiment with Mixed Precision (FP16) to make your training $2\times$ faster on GPUs.Genomic Project: Re-train your Enhancer CNN or Micro-Transformer using the Lightning framework.Deliverable: A high-performance training pipeline that includes live loss curves and automatic model versioning.| TODO |
